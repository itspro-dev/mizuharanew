...
import ShinobuRobot.modules.sql.global_bans_sql as sql
from ShinobuRobot.modules.sql.users_sql import get_user_com_chats
...
from ShinobuRobot.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    if gban_time > 60:
        ...
        message.reply_text("Done! Kardiya Gbanned.", parse_mode=ParseMode.HTML)
    else:
        message.reply_text("Done! Kardiya Gbanned.", parse_mode=ParseMode.HTML)
