...
from ShinobuRobot import telethn as SaitamaTelethonClient
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/AyaneRobotUpdates/9">?</a>]'.format(
            bot.username,
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/AyaneRobotUpdates/10)
"""
