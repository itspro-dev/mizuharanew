...
from ShinobuRobot import telethn as bot
from ShinobuRobot.modules.urluploader import download_file
from ShinobuRobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *@AyaneRobot*",
            )
        except Exception as e:
            traceback.print_exc()
