...
import ShinobuRobot.modules.sql.welcome_sql as sql
import ShinobuRobot
...
from ShinobuRobot.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                creator = None
                if not ShinobuRobot.ALLOW_CHATS:
