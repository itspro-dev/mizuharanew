...
# By @TroJanzHEX
from AyaneRobot.ImageEditor.edit_1 import (
    black_white,
    box_blur,
    bright,
    g_blur,
...
from AyaneRobot.ImageEditor.edit_2 import (
    cartoon,
    circle_with_bg,
    circle_without_bg,
    contrast,
...
from AyaneRobot.ImageEditor.edit_3 import (
    black_border,
    blue_border,
    green_border,
    red_border,
)
from AyaneRobot.ImageEditor.edit_4 import (
    inverted,
    removebg_plain,
    removebg_sticker,
    removebg_white,
...
from AyaneRobot.ImageEditor.edit_5 import (
    normalglitch_1,
    normalglitch_2,
    normalglitch_3,
    normalglitch_4,
...
from AyaneRobot import pbot as Client
...
__help__ = """
<b> IMAGE EDITOR </b>
AyaneRobot have some advanced image editing tools inbuilt
