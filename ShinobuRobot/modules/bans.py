...
from ShinobuRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    connection_status,
    is_user_admin,
...
from ShinobuRobot.modules.helper_funcs.extraction import extract_user_and_text
from ShinobuRobot.modules.helper_funcs.string_handling import extract_time
from ShinobuRobot.modules.log_channel import gloggable, loggable
...
BAN_HANDLER = CommandHandler(["ban", "sban","chamarban"], ban, run_async=True)
TEMPBAN_HANDLER = CommandHandler(["tban"], temp_ban, run_async=True)
PUNCH_HANDLER = CommandHandler("punch", punch, run_async=True)
UNBAN_HANDLER = CommandHandler(["unban", "chamarunban"], unban, run_async=True)
